...
rsvpLookupJs = document.createElement('script'),
...
rsvpLookupJs.type = 'text/javascript',
...
rsvpLookupJs.src = site.theme_path + '/js/rsvplookup.js'+qstring;
...
pluginsJs.onload = function() {
	...
	if(document.querySelector('.rsvp')) {
		...
		document.body.appendChild(rsvpLookupJs);
	}
